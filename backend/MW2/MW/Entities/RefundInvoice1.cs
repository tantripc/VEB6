...
public partial class RefundInvoice1
{
    ...
    public string RootIntegrateKey { get; set; } = null!;

    public string RootInvoiceTemplateCode { get; set; } = null!;

    public string RootInvoiceSeries { get; set; } = null!;

    public string RootInvoiceNumber { get; set; } = null!;
